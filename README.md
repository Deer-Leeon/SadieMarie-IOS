...
| `SadieMarieNotifications/` | Notification Service extension (rich push placeholder) |
...
**Extension schemes:** `SadieMarieWidgets` (widget preview), `SadieMarieNotifications` (notification service extension).
